...
const moduleName = 'ScoutBridgeDefaults';
const path = require('path');
const canonicalName = packageName + path.sep + moduleName;
/**
 * A constant representing all the default properties of an ScoutBridge.
 *
 * @module dxp3-net-udp/ScoutBridgeDefaults
 */
...
const ScoutBridgeDefaults = {
	 ...
	 * 239.128.1.1
	 */
	DEFAULT_MULTICAST_ADDRESS: ScoutDefaults.DEFAULT_MULTICAST_ADDRESS,
	/**
	 ...
	 */
	DEFAULT_MULTICAST_PORT: ScoutDefaults.DEFAULT_PORT,
	/**
	 ...
	 */
	DEFAULT_ENCRYPTION_ALGORITHM: ScoutDefaults.DEFAULT_ENCRYPTION_ALGORITHM,
	/**
...
module.exports = ScoutBridgeDefaults;