 ...
 *
 * NAME
 * SQLLessOrEqualCondition
 */
const packageName = 'dxp3-lang-sql';
const moduleName = 'SQLLessOrEqualCondition';
...
/**
 * @module dxp3-lang-sql/SQLLessOrEqualCondition
 */
...
class SQLLessOrEqualCondition extends SQLSingleCondition {
    /*********************************************
     * CONSTRUCTOR
     ********************************************/
    ...
    async evaluateWhere(_sqlTable) {
        ...
        if(this.operandType === SQLSingleCondition.OPERANDTYPE.COLUMN_COLUMN) {
            result = await tableIndex.lessOrEqualColumn(this._rightOperand.getName());            
        } else {
            result = await tableIndex.lessOrEqual(this._rightOperand);
        }
        return result;
    }
...
module.exports = SQLLessOrEqualCondition;