 ...
 *
 * NAME
 * SQLAlterTableAlterColumnQuery
 */
const packageName = 'dxp3-lang-sql';
const moduleName = 'SQLAlterTableAlterColumnQuery';
...
/**
 * @module dxp3-lang-sql/SQLAlterTableAlterColumnQuery
 */
...
class SQLAlterTableAlterColumnQuery extends SQLQuery {
    /*********************************************
     * CONSTRUCTOR
     ********************************************/
    ...
    async execute(_sqlConnection) {
        ...
        let result = await _sqlConnection.alterTableAlterColumns(this._tableName, this._columns);
        return result;
    }
...
module.exports = SQLAlterTableAlterColumnQuery;