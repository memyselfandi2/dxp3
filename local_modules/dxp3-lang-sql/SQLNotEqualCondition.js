 ...
 *
 * NAME
 * SQLNotEqualCondition
 */
const packageName = 'dxp3-lang-sql';
const moduleName = 'SQLNotEqualCondition';
...
/**
 * @module dxp3-lang-sql/SQLNotEqualCondition
 */
...
class SQLNotEqualCondition extends SQLSingleCondition {
    /*********************************************
     * CONSTRUCTOR
     ********************************************/
    ...
    async evaluateWhere(_sqlTable) {
        ...
        if(this.operandType === SQLSingleCondition.OPERANDTYPE.COLUMN_COLUMN) {
            result = await tableIndex.unequalColumn(this._rightOperand.getName());            
        } else {
            result = await tableIndex.unequal(this._rightOperand);
        }
        return result;
    }
...
module.exports = SQLNotEqualCondition;