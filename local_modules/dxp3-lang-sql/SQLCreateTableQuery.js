...
const moduleName = 'SQLCreateTableQuery';
...
/**
 * @module dxp3-lang-sql/SQLCreateTableQuery
 */
...
class SQLCreateTableQuery extends SQLQuery {
    /*********************************************
     * CONSTRUCTOR
     ********************************************/
    ...
    async execute(_sqlConnection) {
        ...
        let result = await _sqlConnection.createTable(this._tableName, this._columns);
        return result;
    }
...
module.exports = SQLCreateTableQuery;