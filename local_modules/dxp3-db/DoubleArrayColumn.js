...
const moduleName = 'DoubleColumn';
const path = require('path');
const canonicalName = packageName + path.sep + moduleName;
/**
 * @module dxp3-db/DoubleColumn
 */
...
class DoubleArrayColumn extends Column {
    ...
    constructor(_uuid, _name) {
        super(_uuid, _name, ColumnType.DOUBLE_ARRAY);
    }
...
if(util.Assert.isFileToExecute(canonicalName)) {
   util.Help.print(DoubleArrayColumn);
   return;
}
module.exports = DoubleArrayColumn;