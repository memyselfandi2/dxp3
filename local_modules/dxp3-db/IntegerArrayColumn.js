...
const moduleName = 'IntegerColumn';
const path = require('path');
const canonicalName = packageName + path.sep + moduleName;
/**
 * @module dxp3-db/IntegerColumn
 */
const Column = require('./Column');
const ColumnType = require('./ColumnType');
const util = require('dxp3-util');

class IntegerArrayColumn extends Column {
    /*********************************************
     * CONSTRUCTOR
     ********************************************/
    ...
    constructor(_uuid, _name) {
        super(_uuid, _name, ColumnType.INTEGER_ARRAY);
    }
...
if(util.Assert.isFileToExecute(canonicalName)) {
   util.Help.print(IntegerArrayColumn);
   return;
}
module.exports = IntegerArrayColumn;