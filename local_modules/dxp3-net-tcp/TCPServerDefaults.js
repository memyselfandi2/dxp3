...
const moduleName = 'TCPServerDefaults';
...
/**
 * A constant representing all the default properties for a TCPServer.
 *
 * @module dxp3-net-tcp/TCPServerDefaults
 */
const logging = require('dxp3-logging');

const TCPServerDefaults = {
	/**
...
module.exports = TCPServerDefaults;