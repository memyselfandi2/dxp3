...
const moduleName = 'JSONClientDefaults';
...
/**
 * <p>A constant representing all the default properties for an JSONClient.</p>
 *
 * @module dxp3-net-json/JSONClientDefaults
 */
const logging = require('dxp3-logging');

const JSONClientDefaults = {
	/**
...
module.exports = JSONClientDefaults;