...
const moduleName = 'FileServerDefaults';
...
/**
 * A constant representing all the default properties for a FileServer.
 *
 * @module dxp3-net-file/FileServerDefaults
 */
const logging = require('dxp3-logging');

const FileServerDefaults = {
	/**
...
module.exports = FileServerDefaults;