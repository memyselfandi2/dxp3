DXP3 - Digital Experience Platform 3 - Management - UI

DESCRIPTION
This module runs the DXP3 Management UI.

The UI has caching capabilities delegated to a caching service (highly likely a redis implementation).
